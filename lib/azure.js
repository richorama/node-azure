...
exports.list_containers = function(account, cb) {
...
exports.create_container = function(account, container_name, cb) {
...
exports.get_container_properties = function(account, container_name, cb) {
...
exports.get_container_metadata = function(account, container_name, cb) {
...
exports.set_container_metadata = function(account, container_name, meta, cb) {
...
exports.delete_container = function(account, container_name, cb) {
...
exports.list_blobs = function(account, container_name, cb) {
...
exports.put_blob = function(account, container_name, blob_type,
...
exports.get_blob = function(account, container_name, blob_name, cb) {
...
exports.delete_blob = function(account, container_name, blob_name, cb) {
...
exports.download_blob = function(account, container_name, blob_name, file_name, cb) {
...
exports.tables = new function(){

	this.core = new function(){
	
		this.query_tables = function (account, cb) {
			var req = {
		...
		this.create_table = function (account, xml, cb) {
			var req = {
				url: account.table_storage_url + '/Tables',
				method: 'POST',
				body: xml,
		...
		this.delete_table = function(account, tablename, cb) {
			var req = { 
		...
		this.insert_entity = function (account, tablename, xml, cb) {
			var req = { 
		...
		this.update_entity = function (account, tablename, xml, partitionKey, rowKey, cb) {
			var req = { 
		...
		this.get_entity = function(account, tablename, partitionKey, rowKey, cb) {
			var req = { 
				url: account.table_storage_url + '/' + tablename + "(PartitionKey='" + partitionKey + "',RowKey='" + rowKey + "')",
				method: 'GET'
			};
		...
		this.query_entities = function(account, tablename, query, cb){
			var req = { 
		...
		this.delete_entity = function(account, tablename, partitionKey, rowKey, cb) {
			var req = { 
				url: account.table_storage_url + '/' + tablename + "(PartitionKey='" + partitionKey + "',RowKey='" + rowKey + "')",
				method: 'DELETE',
				headers : {'Content-Type': 'application/atom+xml', 'If-Match': '*'}
	...
	this.create_table = function (account, table_name, cb) {
		...
		this.core.create_table(account, xml, function(res){
			cb(res.statusCode == HTTP_CREATED);
		});
	}
	...
	// callback contains the response
	this.insert_entity = function (account, tablename, data, cb) {
	...
	// callback contains the response
	this.update_entity = function (account, tablename, data, cb) {
